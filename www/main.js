...
module.exports = __webpack_require__(/*! /Users/admin/Documents/license/sample-app/src/main.ts */"zUnb");
...
const routes = [
    ...
    {
        path: 'scan',
        loadChildren: () => Promise.all(/*! import() | pages-scan-scan-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-scan-scan-module")]).then(__webpack_require__.bind(null, /*! ./pages/scan/scan.module */ "Fo4Z")).then(m => m.ScanPageModule)
    },
    {
        path: '',
        redirectTo: 'home',
